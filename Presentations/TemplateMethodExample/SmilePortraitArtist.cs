...
public partial class SmilePortraitArtist : PortraitArtist
{
    ...
    {
        Vector2 postion = nose.position + new Vector2(0, 150);
        Vector2 size = new(200, 200);
        DrawArc(
            center: postion,
            radius: size.X / 2,
            startAngle: Mathf.DegToRad(45 ),
              endAngle: Mathf.DegToRad(135),
            pointCount: 10,
            Colors.Crimson,
            width: 10,
            antialiased: true);
